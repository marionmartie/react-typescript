                    ...
                    <div
                        ...
                        <div className="md:ml-auto">
                            <div className="flex space-x-2">
                                ...
                                <a
                                    href="/jobs.html"
                                    className="text-white hover:bg-gray-900 hover:text-white rounded-md px-3 py-2">Jobs</a>
                                <a
                                    href="/add-job.html"
                                    className="text-white hover:bg-gray-900 hover:text-white rounded-md px-3 py-2">Add Job</a>
                            </div>
                        </div>
                    </div>
                </div>
